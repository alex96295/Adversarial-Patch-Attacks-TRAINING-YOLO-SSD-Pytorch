...
if __name__ == '__main__':
    ...
    class PatchTrainer(object):
        ...
        def train(self):
            ...
            destination_path = "./"
            destination_name = 'loss_tracking_mbntv1ssd_objcls_meanstd.txt'
            destination_name2 = 'loss_tracking_compact_batch_mbntv1ssd_objcls_meanstd.txt'
            destination_name3 = 'loss_tracking_compatc_epochs_mbntv1ssd_objcls_meanstd.txt'
            ...
            for epoch in range(n_epochs):
                ...
                for i_batch, (img_batch, lab_batch) in tqdm(enumerate(train_loader), desc=f'Running epoch {epoch}',
                    ...
                    with autograd.detect_anomaly():
                        ...
                        output = self.mbntv1_ssd_model.forward(p_img_batch)

                        loss_type = 'max_approach'

                        #max_prob = self.prob_extractor(output)
                        score_ssd_mbntv1 = self.score_extractor_ssd(output, loss_type)
                        ...
                        # batch_op: mean, max...
                        det_loss = torch.mean(score_ssd_mbntv1)
                        ...
                        if i_batch + 1 >= len(train_loader):
                            ...
                            del adv_batch_t, output, score_ssd_mbntv1, det_loss, p_img_batch, nps_loss, tv_loss, loss
                ...
                if True:
                    ...
                    # plt.imshow(im)
                    # plt.show()
                    im.save("./saved_patches_mytrial/mbntv1ssd_max_objcls_meanstd.png")
